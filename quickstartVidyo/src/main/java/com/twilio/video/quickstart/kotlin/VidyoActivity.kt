...
class VidyoActivity : AppCompatActivity() {
    ...
    private val sharedPreferences by lazy {
        PreferenceManager.getDefaultSharedPreferences(this@VidyoActivity)
    }
...
//        }
        ...
        return View.OnClickListener {
            ...
            localVideoTrack?.let {
                ...
                binding.localVideoActionFab.setImageDrawable(
                    ContextCompat.getDrawable(this@VidyoActivity, icon),
                )
            }
        }
    }
    ...
    private fun retrieveAccessTokenfromServer() {
        ...
        videoViewModel.tokenLiveData.observe(this){
            this@VidyoActivity.accessToken = it
            Log.d(TAG, "retrieveAccessTokenfromServer token: $it")
        }

        videoViewModel.getToken("jain","Tuesday9Jan", "21269871406554")
